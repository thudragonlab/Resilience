...
def find_optimize_link_pool(_dsn_path, cname):
    ...
    os.makedirs(optimize_link_path,exist_ok=True)
    ...
    week_point_and_break_link = sorted(
        week_point_and_break_link.items(), key=lambda d: len(d[1]), reverse=True)
    Res = {}
    ...
    for i in range(range_num):
        ...
        if len(break_link) == 0:
            ...
            print('第'+str(i)+'组 ', len(break_link))
